...
11. Community loop: anonymous faction tally, honest country leaderboard, real transactional trading/gifting, sharing/referrals and creator acquisition links. **In progress.** One open offer per player, slim board, server accept, race from real pulls, level bonus card, party pip on the avatar.
