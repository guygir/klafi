...
export const TIPS_STEPS = Object.freeze([
  {
    ...
    arrowTo: "",
    title: "המשחק",
    body: "המחסן אוסף לבד כל שלוש שעות. כשיש קלף — פתחו אותו. הוא נרשם לאוסף רק אחרי שרואים אותו.",
  },
  {
    id: 2,
    ring: "#pack-action",
  ...
  home: Object.freeze([
    {
      ...
      title: "היום",
      body: "זה מסך היום. המחסן ממשיך לאסוף קלף כל שלוש שעות, גם בלי שתיגעו. מתחת לכותרת — שעון שמראה מתי מגיע הבא. אם יש חלון מיוחד, שורת האירוע רצה למעלה.",
    },
    {
      ring: "#open-pack",
      arrowTo: "#cooldown-copy",
      title: "פתיחה",
      body: "יש קלף במחסן? לחצו על «פתיחת קלף». האוסף, הרמה והמפלגה מתעדכנים רק אחרי שרואים אותו. שיתוף שולח תמונה בלבד — לא את הקלף עצמו.",
    },
    {
      ring: "#level-avatar-button",
      title: "האווטאר",
      body: "כאן הפנים שלכם, אות המפלגה, והאש של רצף הכניסות. לחיצה פותחת את הפרופיל ואת האווטארים.",
    },
    {
      ring: ".today-docket",
      title: "המרוץ",
    ...
    },
    {
      ...
      place: "above",
      title: "הניווט",
      body: "למטה: היום, אוסף, הישגים, קהילה. מתחת לסרגל יושבים גילוי נאות ודיווח באג.",
    },
  ]),
  pack: Object.freeze([
    {
...
export function leftoverPackHint(text) {
  return /הקלף כבר שמור/.test(String(text || ""));
}
